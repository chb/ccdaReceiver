...
( function(NS, $) {
		...
		var DEBUG_MODE = NS.chartSettings.appEnvironment === "DEVELOPMENT", 
			...
			END_AGE_MOS = null, 
			GENDER = null, 
			MILISECOND = NS.Constants.TIME.MILISECOND, 
			SECOND = NS.Constants.TIME.SECOND, 
			MINUTE = NS.Constants.TIME.MINUTE, 
			HOUR = NS.Constants.TIME.HOUR, 
			DAY = NS.Constants.TIME.DAY, 
			WEEK = NS.Constants.TIME.WEEK, 
			MONTH = NS.Constants.TIME.MONTH, 
			YEAR = NS.Constants.TIME.YEAR, 
			RENDER_FOR_PRINT = $("html").is(".before-print"), 
			PRINT_WINDOW = null, 
			ANNOTATIONS_WINDOW = null,
			imagesToPreload = [
				"img/pview/weights/Female 12-19yrs HEALTHY active.png",
				"img/pview/weights/Female 12-19yrs HEALTHY.png",
				"img/pview/weights/Female 12-19yrs OBESE active.png",
				"img/pview/weights/Female 12-19yrs OBESE.png",
				"img/pview/weights/Female 12-19yrs OVERWEIGHT active.png",
				"img/pview/weights/Female 12-19yrs OVERWEIGHT.png",
				"img/pview/weights/Female 12-19yrs UNDERWEIGHT active.png",
				"img/pview/weights/Female 12-19yrs UNDERWEIGHT.png",
				"img/pview/weights/Female 4-12yrs HEALTHY active.png",
				"img/pview/weights/Female 4-12yrs HEALTHY.png",
				"img/pview/weights/Female 4-12yrs OBESE active.png",
				"img/pview/weights/Female 4-12yrs OBESE.png",
				"img/pview/weights/Female 4-12yrs OVERWEIGHT active.png",
				"img/pview/weights/Female 4-12yrs OVERWEIGHT.png",
				"img/pview/weights/Female 4-12yrs UNDERWEIGHT active.png",
				"img/pview/weights/Female 4-12yrs UNDERWEIGHT.png",
				"img/pview/weights/Infant HEALTHY active.png",
				"img/pview/weights/Infant HEALTHY.png",
				"img/pview/weights/Infant OBESE active.png",
				"img/pview/weights/Infant OBESE.png",
				"img/pview/weights/Infant OVERWEIGHT active.png",
				"img/pview/weights/Infant OVERWEIGHT.png",
				"img/pview/weights/Infant UNDERWEIGHT active.png",
				"img/pview/weights/Infant UNDERWEIGHT.png",
				"img/pview/weights/Male 12-19yrs HEALTHY active.png",
				"img/pview/weights/Male 12-19yrs HEALTHY.png",
				"img/pview/weights/Male 12-19yrs OBESE active.png",
				"img/pview/weights/Male 12-19yrs OBESE.png",
				"img/pview/weights/Male 12-19yrs OVERWEIGHT active.png",
				"img/pview/weights/Male 12-19yrs OVERWEIGHT.png",
				"img/pview/weights/Male 12-19yrs UNDERWEIGHT active.png",
				"img/pview/weights/Male 12-19yrs UNDERWEIGHT.png",
				"img/pview/weights/Male 4-12yrs HEALTHY active.png",
				"img/pview/weights/Male 4-12yrs HEALTHY.png",
				"img/pview/weights/Male 4-12yrs OBESE active.png",
				"img/pview/weights/Male 4-12yrs OBESE.png",
				"img/pview/weights/Male 4-12yrs OVERWEIGHT active.png",
				"img/pview/weights/Male 4-12yrs OVERWEIGHT.png",
				"img/pview/weights/Male 4-12yrs UNDERWEIGHT active.png",
				"img/pview/weights/Male 4-12yrs UNDERWEIGHT.png",
				"img/pview/weights/Toddler HEALTHY active.png",
				"img/pview/weights/Toddler HEALTHY.png",
				"img/pview/weights/Toddler OBESE active.png",
				"img/pview/weights/Toddler OBESE.png",
				"img/pview/weights/Toddler OVERWEIGHT active.png",
				"img/pview/weights/Toddler OVERWEIGHT.png",
				"img/pview/weights/Toddler UNDERWEIGHT active.png",
				"img/pview/weights/Toddler UNDERWEIGHT.png",
		...
		function selectRangeForAge(age) {
			...
			$('input:radio[name="time-range"]').each(function(i, o) {
				...
				if (GC.Util.floatVal(values[0]) <= weeks && GC.Util.floatVal(values[1]) >= weeks) {
		...
		function getFitRange() {
			var first = PATIENT.getFirstModelEntry(), last = PATIENT.getLastModelEntry(), step, lastAge, range;
		...
		NS.App.dialog = function(url, args, options) {
			...
			$("#dialog").empty().html('<div class="content">' + '<p style="text-align:center">' + '<img src="img/spinner.gif" />' + '<br />' + '<br />' + 'Loading...' + '</p>' + '</div>').data("dialogProxy", {
				"arguments" : $.makeArray(args)
			}).dialog("close").dialog("option", $.extend({
				minWidth : 300,
				width : 300,
				title : "Loading...",
				position : "center"
		...
		NS.App.editParents = function() {
			GC.App.dialog("edit-parents.html", null, {
				modal : true,
				width : "auto",
				title : "Add/Edit Parental Heights"
			});
		};
		...
		$(function initUI() {
			...
			$("html").bind("set:language", translateHTML);
			translateHTML();
			...
			function renderPatient() {
				...
				$("[name=GA]").val(PATIENT.getGestatonCorrection().toString(GC.chartSettings.timeInterval));
			...
			function setInitialState(done) {
				...
				$("html").toggleClass("debug-mode", DEBUG_MODE).toggleClass("dev", GC.chartSettings.appEnvironment == "DEVELOPMENT").toggleClass("prod", GC.chartSettings.appEnvironment == "PRODUCTION").toggleClass("has-rgba", hasRGBA).toggleClass("no-rgba", !hasRGBA).toggleClass("has-box-shadow", !!hasBoxShadow).toggleClass("no-box-shadow", !hasBoxShadow).toggleClass("has-border-radius", !!hasBorderRadius).toggleClass("no-border-radius", !hasBorderRadius).toggleClass("has-transitions", !!hasTransition).toggleClass("no-transitions", !hasTransition).toggleClass("has-transforms", !!hasTransform).toggleClass("no-transforms", !hasTransform).toggleClass("ie", $.browser.msie === true);
			...
			function initUIControls(done) {
				...
				$("html").bind("set:viewType", function(e, type) {
					...
					$("html").toggleClass("view-clinical", type == "graphs" || type == "table").toggleClass("view-parental", type == "parent").toggleClass("view-charts", type == "graphs").toggleClass("view-table", type == "table");
				...
				////////////////////////////////////////////////////////////////
				$("#primary-ds").menuButton("forEachOption", function(i, o) {
				...
				}).stepInput("value", GC.Preferences.prop("gestCorrectionTreshold"));
				...
				}).stepInput("value", PATIENT.familyHistory.father.height || "");
				...
				}).stepInput("value", PATIENT.familyHistory.mother.height || "");
				...
				}).stepInput("value", GC.Preferences.prop("fontSize"));
			...
			function showLastRecOrSelection() {
				...
				var lastRec = PATIENT.getLastModelEntry(), rec = GC.SELECTION.selected.record || lastRec, type = rec === lastRec ? "last" : "selected", date, age;
				...
				age = new GC.TimeInterval(PATIENT.DOB).setMonths(rec.agemos);
				date = age.getEndDate();

				$(".last-recording").show().find("> span").html(type + "&nbsp;recording&nbsp;&nbsp;");
			...
			function setUIValues(done) {
				//var gestation = new GC.TimeInterval();
			...
			QUEUE.add("Loading data...", loadData);
			
			QUEUE.add("Preload images...", function(done) {

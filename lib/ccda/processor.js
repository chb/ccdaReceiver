...
Processor.asString.jsType = "string";

Processor.asBoolean = function(v){
  return v==='true';
};
Processor.asBoolean.jsType = "boolean";

Processor.asFloat = function(v){
  return parseFloat(Processor.asString(v));
};
Processor.asFloat.jsType = "number";
...
Processor.asFloat.jsType = "string";
...
Processor.asTimestampResolution.jsType = "string: `year` | `month` | `day` | `hour` | `minute` | `second` | `subsecond`";
...
Processor.pathExists.jsType = "boolean";
